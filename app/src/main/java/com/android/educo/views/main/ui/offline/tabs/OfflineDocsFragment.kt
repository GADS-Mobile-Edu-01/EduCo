...
import com.android.educo.databinding.FragmentOfflineDocsBinding
 ...
 * Author: A. L. Zailani
 */
class OfflineDocsFragment : Fragment() {
    private lateinit var viewModel: OfflineViewModel
    private lateinit var mBinding: FragmentOfflineDocsBinding

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        mBinding = FragmentOfflineDocsBinding.inflate(inflater)
